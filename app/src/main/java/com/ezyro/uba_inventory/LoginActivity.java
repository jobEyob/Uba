...
public class LoginActivity extends AppCompatActivity {
    ...
    public void login() {
        ...
        String upassword = pref.getString("password",null);
...
//                }, 3000);
    ...
    public void onBackPressed() {
        // disable going back to the MainActivityOlde
        moveTaskToBack(true);
    }
    ...
    public void onLoginFailed() {
        ...
        Toasty.error(getBaseContext(), "Login failed !! Incorrect email or Password", Toast.LENGTH_SHORT, true).show();
